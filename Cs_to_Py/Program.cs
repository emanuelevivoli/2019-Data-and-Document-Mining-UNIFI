...
namespace ConsoleApp2
{
    public class Stream_Read_Write
    {
        ...
        {
            string path = "C:\\Users\\emanuelevivoli\\source\\repos\\ConsoleApp2\\ConsoleApp2\\test.py";
            string iter = "3";
            string input = "Hello";
        ...
        private static void stream_read_write(string path, string iter, string input)
        {
            ...
            start.FileName = "C:\\Users\\emanuelevivoli\\AppData\\Local\\Programs\\Python\\Python37\\python.exe";  //"C:\\Python27\\python.exe";
